...
png("Plots/adjustedFemale_Gspp_last_sex_sp.png", width = 2700, height = 1200, res = 300)
...
ggplot(mastertable, aes(x = days_grouped, y = GV_log_copies_swab)) +
  ...
  labs(
    title = expression(italic("Gardnerella spp.") * " DNA copy number in relation to days since last sexual intercourse - adjusted female"),
