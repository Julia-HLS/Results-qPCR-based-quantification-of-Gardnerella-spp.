...
png("Plots/T2_Gspp_load_vaginal_penile_protection.png", width = 2700, height = 1200, res = 300)
...
ggplot(paired_data, aes(x = Vaginal, y = `Penile skin`)) +
  ...
  # Axis titles
  labs(
    title = expression(italic("Gardnerella spp.") * " load: vaginal and penile within couples at Timepoint 2"),
